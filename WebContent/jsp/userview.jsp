...
<%@include file="/jsp/common/head.jsp"%>
 <div class="right">
        ...
        <div class="providerView">
            ...
            <p><strong>证件照：</strong><span><img alt="证件照" src="${pageContext.request.contextPath}/statics/images/pics/${user.idPicPath}" height="150px" width="150px"></span></p>
            <p><strong>工作证照片：</strong><span><img alt="工作证照片" src="${pageContext.request.contextPath }/statics/images/pics/${user.workPicPath}"  height="150px" width="150px"></span></p>
